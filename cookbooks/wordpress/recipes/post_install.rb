...
execute 'Finish Wordpress installation' do
  command 'sudo -u vagrant -i -- wp core install --path=/opt/wordpress/ --url=192.168.56.2 --locale=es_ES --title="EPNEWMAN - Herramientas de automatización de despliegues by Carlos Zelada Melchor" --admin_user=admin --admin_password="Epnewman123" --admin_email=admin@epnewman.edu.pe'
